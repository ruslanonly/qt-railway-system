...
int main(int argc, char *argv[])
{
    ...
    "QLineEdit, QDateTimeEdit, QComboBox {border: 1.5px solid #DCDCDD; padding: 5px; border-radius: 5px; font-weight: 500; font-size: 9pt;}"
    "QLineEdit:hover, QDateTimeEdit:hover, QComboBox:hover {border-color: #C5C3C6}"
    "QLineEdit:focus, QDateTimeEdit:focus, QComboBox:focus {border-color: #0466C8;}"
