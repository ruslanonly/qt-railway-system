...
public:
    ...
    void setupUi(QWidget *AddScheduleModal)
    {
        ...
        AddScheduleModal->resize(400, 300);
        ...
        arrivalStationLabel = new QLabel(AddScheduleModal);
        arrivalStationLabel->setObjectName("arrivalStationLabel");

        inputGroup_8->addWidget(arrivalStationLabel);

        arrStationComboBox = new QComboBox(AddScheduleModal);
        ...
        nameLabel = new QLabel(AddScheduleModal);
        nameLabel->setObjectName("nameLabel");

        inputGroup_6->addWidget(nameLabel);

        nameInput = new QLineEdit(AddScheduleModal);
    ...
    void retranslateUi(QWidget *AddScheduleModal)
    {
        ...
        arrivalStationLabel->setText(QCoreApplication::translate("AddScheduleModal", "\320\241\321\202\320\260\320\275\321\206\320\270\321\217 \320\277\321\200\320\270\320\261\321\213\321\202\320\270\321\217", nullptr));
        ...
        departureStationLabel->setText(QCoreApplication::translate("AddScheduleModal", "\320\241\321\202\320\260\320\275\321\206\320\270\321\217 \320\276\321\202\320\277\321\200\320\260\320\262\320\273\320\265\320\275\320\270\321\217", nullptr));
        nameLabel->setText(QCoreApplication::translate("AddScheduleModal", "\320\235\320\260\320\267\320\262\320\260\320\275\320\270\320\265", nullptr));
